...
`
  ...
  install() {
    ...
    switch(this.database) {
      case 'postgres':
        dbDependencies.push('@foal/sequelize@0.4.0-beta.0', 'pg@6', 'pg-hstore');
        break;
      case 'mysql':
        dbDependencies.push('@foal/sequelize@0.4.0-beta.0', 'mysql2');
        break;
    }
    if (this.authentication) {
      dbDependencies.push('@foal/authentication@0.4.0-beta.0', 'bcrypt-nodejs');
    }
